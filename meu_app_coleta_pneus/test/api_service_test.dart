...
void main() {
  ...
  group('ApiService - cancelarColeta', () {
    test('sucesso (200) retorna coleta cancelada', () async {
      final servico = servicoCom(
        (caminho, cabecalhos) async => RespostaHttp(200, '[]'),
        enviarEscrita: (caminho, cabecalhos, corpo) async {
      ...
      final resultado = await servico.cancelarColeta('11111111-2222-4333-8444-555555555555');

      expect(resultado['id'], '11111111-2222-4333-8444-555555555555');
      expect(resultado['status'], 'CANCELADA');
    });
    ...
    test('403 lança exceção (não permitido)', () async {
      ...
      expect(() => servico.cancelarColeta('11111111-2222-4333-8444-555555555555'), throwsA(isA<Exception>()));
    });
    ...
    test('404 lança exceção (coleta não encontrada)', () async {
      ...
      expect(() => servico.cancelarColeta('nonexistent-id'), throwsA(isA<Exception>()));
    });
